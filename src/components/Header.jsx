...
function Header() {
  ...
  return (
    <div>
        <div className='flex justify-between items-center max-w-250 mx-auto shadow-sm p-2'>
        ...
        <div className={`max-w-250 mx-auto absolute lg:hidden top-20 left-0 bg-white w-full transform transition-tranform ${isMenuOpen ? "opacity-100": "opacity-0"}`} style={{transition: "transform 0.3s ease, opacity 0.3s ease"}}>
            <li className='list-none text-center hover:text-white hover:bg-[#DA9F58] rounded-xl p-2 my-1'>Movies</li>
            <li className='list-none text-center hover:text-white hover:bg-[#DA9F58] rounded-xl p-2 mb-1'>Favourites</li>
            <div className='flex bg-[#DA9F58] p-2 rounded-xl shadow-md justify-center mb-4'>
                <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#FFFFFF"><path d="M480-120v-80h280v-560H480v-80h280q33 0 56.5 23.5T840-760v560q0 33-23.5 56.5T760-120H480Zm-80-160-55-58 102-102H120v-80h327L345-622l55-58 200 200-200 200Z"/></svg>
                <span className='text-white'>Login</span>
            </div>
            <div className='flex font-semibold border-1 rounded-xl p-2 shadow-md justify-center'>
                <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#000000"><path d="M480-360 280-560h400L480-360Z"/></svg>
                <span className='text-md'>ENG</span>
            </div>
        </div>
